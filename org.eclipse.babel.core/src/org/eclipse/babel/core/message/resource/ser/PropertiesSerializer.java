...
public class PropertiesSerializer {
    ...
    static {
        FORCED_LINE_SEP[PropertiesSerializerConfig.NEW_LINE_DEFAULT] = null;
        FORCED_LINE_SEP[PropertiesSerializerConfig.NEW_LINE_UNIX] =
                "\\\\n"; //$NON-NLS-1$
        FORCED_LINE_SEP[PropertiesSerializerConfig.NEW_LINE_WIN] = 
                "\\\\r\\\\n"; //$NON-NLS-1$
        FORCED_LINE_SEP[PropertiesSerializerConfig.NEW_LINE_MAC] =
                "\\\\r"; //$NON-NLS-1$
    }

    private PropertiesSerializerConfig config;
    
    /**
     * Constructor.
     */
    public PropertiesSerializer(PropertiesSerializerConfig config) {
        super();
        this.config = config;
    }
...
//        text.append(key);
    ...
    private String getKeyGroup(String key) {
        ...
        int deepness = config.getGroupLevelDeepness();
        int endIndex = 0;
        int levelFound = 0;
