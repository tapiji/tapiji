...
public interface IRefactoringService {
	 ...
	 * @param resourceBundleId The resource bundle, which contains the key to be refactored.
	 * @param selectedLocale The selected {@link Locale} to change.
	 ...
	 * </ol>
	 * <br>
	 * @param file The file, of the editor input
	 * @param selectionOffset The position of the cursor
	 */
