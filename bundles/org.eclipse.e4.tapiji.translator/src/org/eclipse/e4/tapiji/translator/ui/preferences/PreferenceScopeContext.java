...
public class PreferenceScopeContext extends EventManager implements IPreferenceStore {
     ...
     */
    public PreferenceScopeContext(IScopeContext context, String qualifier, String defaultQualifierPath) {
     ...
     */
    public PreferenceScopeContext(IScopeContext context, String qualifier) {
    ...
    private INodeChangeListener getNodeChangeListener() {
        return new IEclipsePreferences.INodeChangeListener() {
            ...
            /*
             * (non-Javadoc)
             * @see org.eclipse.core.runtime.preferences.IEclipsePreferences.INodeChangeListener#added(org.eclipse.core.
             * runtime.preferences.IEclipsePreferences.NodeChangeEvent)
             */
            @Override
             ...
             * (non-Javadoc)
             * @see
             * org.eclipse.core.runtime.preferences.IEclipsePreferences.INodeChangeListener#removed(org.eclipse.core.
             * runtime.preferences.IEclipsePreferences.NodeChangeEvent)
             */
            @Override
    ...
    private void initializePreferencesListener() {
        if (preferencesListener == null) {
            preferencesListener = new IEclipsePreferences.IPreferenceChangeListener() {
                 ...
                 * (non-Javadoc)
                 * @see
                 * org.eclipse.core.runtime.preferences.IEclipsePreferences.IPreferenceChangeListener#preferenceChange(
    ...
    private IEclipsePreferences getDefaultPreferences() {
        return storeContext.getNode(defaultQualifier);
    }
    ...
    public void setSearchContexts(IScopeContext[] scopes) {
        ...
        for (int i = 0; i < scopes.length; i++) {
            if (scopes[i].equals(storeContext)) {
                Assert.isTrue(false, "Assert that the default was not included (we automatically add it to");
            }
        }
    }
