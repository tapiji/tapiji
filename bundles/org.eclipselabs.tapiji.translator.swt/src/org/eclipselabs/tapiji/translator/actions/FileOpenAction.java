...
public class FileOpenAction extends AbstractFileOpenAction {
  ...
  public void run(IAction action) {
    String[] fileNames = FileUtils.queryFileName(window.getShell(), "Open Resource-Bundle", SWT.OPEN,
    ...
    if (!FileUtils.isResourceBundle(fileName)) {
      MessageDialog.openError(window.getShell(), "Cannot open Resource-Bundle",
    ...
    try {
      page.openEditor(
              new FileEditorInput(FileUtils.getResourceBundleRef(fileName, FileUtils.EXTERNAL_RB_PROJECT_NAME)),
