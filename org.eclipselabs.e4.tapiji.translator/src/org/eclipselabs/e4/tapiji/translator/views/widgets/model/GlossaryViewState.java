 ...
 ******************************************************************************/
package org.eclipselabs.e4.tapiji.translator.views.widgets.model;
...
/**
 * Should use dialogsettings or preference store
 */
@Deprecated
public class GlossaryViewState {
  ...
  public GlossaryViewState(List<Locale> visibleLocales, SortInfo sortings, boolean fuzzyMatchingEnabled,
