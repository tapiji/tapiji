...
public class KeyRefactoringSummaryDialog extends KeyRefactoringDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		Composite dialogArea =  new Composite(parent, SWT.NONE); //(Composite) super.createDialogArea(parent);
	...
	private void initLayout(Composite parent) {
		...
		changesText.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
	...
	/**
	 * @param changeSet The change set of the refactoring operation, which contains
	...
	public void create() {
		...
		this.setTitle("Summary of the key refactoring: " + config.getPreselectedKey() + " -> " + 
				config.getNewKey());
		this.setMessage("The resource bundle " + config.getPreselectedBundle() + " and " +
				changeSet.size() + " files of the project " + config.getProjectName() + 
