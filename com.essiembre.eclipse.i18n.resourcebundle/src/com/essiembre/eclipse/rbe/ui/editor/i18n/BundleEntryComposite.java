 ...
 * @version $Author: nl_carnage $ $Revision: 1.27 $ $Date: 2007/09/12 16:02:51 $
 */
public class BundleEntryComposite extends Composite {

	final boolean showComment = false;
...
//		createTextRow();
    ...
    private void createLabelRow() {
        ...
        GridData lblData = new GridData (GridData.END, GridData.CENTER, false, false);
        txtLabel.setLayoutData(lblData);
        txtLabel.setText("Comment:");
        txtLabel.setVisible(showComment);

        
        // CommentBox
        txtComment = new Text(labelComposite, SWT.BORDER);
        GridData commentData = new GridData(GridData.BEGINNING, GridData.CENTER, true, false);
        commentData.widthHint = 1500;
        txtComment.setLayoutData(commentData);
        txtComment.setEditable(false);
        txtComment.setVisible(showComment);
