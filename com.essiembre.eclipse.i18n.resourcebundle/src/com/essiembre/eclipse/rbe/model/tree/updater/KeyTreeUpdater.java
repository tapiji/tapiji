 ...
 */
public abstract class KeyTreeUpdater implements IKeyTreeUpdater {
     ...
     */
    public abstract void addKey(IKeyTree keyTree, String key);
     ...
     */
    public void removeKey(IKeyTree keyTree, String key) {
