...
public class IncompletionUpdater extends KeyTreeUpdater {
     ...
     * 
     * @param iBundleGroup     A container for the i18n information.
     * @param delegate  The update which will be used for delegation. Mainly
     *                  intended for structural information.
     */
    public IncompletionUpdater(IBundleGroup iBundleGroup, KeyTreeUpdater delegate) {
        delegation  = delegate;
     ...
     * {@inheritDoc}
     */
    public void addKey(IKeyTree keytree, String key) {
