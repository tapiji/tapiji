 ...
 */
public class KeyTreeItem implements Comparable<KeyTreeItem>, IKeyTreeItem, IKeyTreeVisitable {

    /** Parent key tree. */
    private IKeyTree keyTree;
    ...
    /** Child items. */
    private final SortedSet<IKeyTreeItem> children = new TreeSet<IKeyTreeItem>();
    
    /**
     * Constructor.
     * @param keyTree2 associated key tree
     * @param id unique identifier
     * @param name name
     */
    public KeyTreeItem(IKeyTree keyTree2, String id, String name) {
        super();
        this.keyTree = keyTree2;
        this.id = id;
        this.name = name;
    }
     ...
     */
    public SortedSet<IKeyTreeItem> getChildren() {
        return children;
    }
    /**
     ...
     */
    public Set<IKeyTreeItem> getNestedChildren() {
        Set<IKeyTreeItem> nestedChildren = new TreeSet<IKeyTreeItem>();
        nestedChildren.addAll(children);
        for (IKeyTreeItem item : children) {
     ...
     * @param k child to add
     */
    public void addChildren(IKeyTreeItem k) {
        children.add(k);
    }
    /**
    ...
    public boolean applyFilter(String filter) {
        ...
        for (IKeyTreeItem child : children) {
