 ...
 */
public class BundleGroup extends Model implements IBundleVisitable, IBundleGroup {

    /** Bundles forming the group (key=Locale; value=Bundle). */
    private final Map<Locale, IBundle> bundles = new HashMap();
...
//	private final List<String> keys = new LinkedList<String>();
    ...
    public void accept(IBundleVisitor visitor, Object passAlongArgument) {
        for (IBundle bundle : bundles.values()) {
     ...
     */
    public void addBundle(Locale locale, IBundle bundle) {
     ...
     */
    public void addBundleEntry(Locale locale, IBundleEntry bundleEntry) {
