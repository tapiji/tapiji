...
public interface IBundleVisitor {
     ...
     */
    public void visitBundleGroup(IBundleGroup group, Object passAlongArgument);
    /**
     * Visits a bundle.
     * @param bundle bundle
     * @param passAlongArgument an optional argument
     */
    public void visitBundle(IBundle bundle, Object passAlongArgument);
    /**
     * Visits a bundle entry.
     * @param entry bundle entry
     * @param passAlongArgument an optional argument
     */
    public void visitBundleEntry(IBundleEntry entry, Object passAlongArgument);
}
