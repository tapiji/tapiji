 ...
 */
public class Bundle extends Model implements IBundleVisitable, IBundle {
     ...
     * @param bundleEntry the bundle entry to add
     */
    public void addEntry(IBundleEntry bundleEntry) {
        BundleEntry oldEntry = (BundleEntry) entries.get(bundleEntry.getKey());
        if (oldEntry != null) {
            if (!oldEntry.equals(bundleEntry)) {
                entries.put(bundleEntry.getKey(), bundleEntry);
     ...
     */    
    protected void copyFrom(IBundle bundle) {
